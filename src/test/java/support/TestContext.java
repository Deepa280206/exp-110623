...
public class TestContext {
    ...
    //If you want to run your tests on the local machine then isHeadless:false and envLinux:false
    //If you want to run your tests on the Jenkins then isHeadless:true and envLinux:true
        ...
        if (testEnv.equals("local")) {
            switch (browser) {
                case "chrome":
                    ...
                    //Added the below three lines to run the tests on Jenkins
                    if (envLinux) {
